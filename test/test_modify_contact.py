...
def test_modify_contact_contact(app):
    if app.contact.count() == 0:
         app.contact.create(Contact(firstname="qwe", lastname="qwe", address="qwe", homephone="qwe", email="qwe"))
    old_contacts = app.contact.get_contact_list()
    index = randrange(len(old_contacts))
    contact = Contact(firstname="2", lastname="2", address="1", homephone="1", email="1")
